...
public class AddPatient  extends BaseDrawerActivityDoctor {
    ...
    public void cmdAdd(View view){
        if(Check()){
            String username = txtFirstName.getText().toString().charAt(0)+""+txtMiddleName.getText().toString().charAt(0)+""+txtLastName.getText().toString();
            String gender = "";
            if(rMale.isChecked())
                gender="Male";
            else
            ...
            Toast.makeText(this,dateStr+"  "+username.toLowerCase(),Toast.LENGTH_LONG).show();
